...
## Context
tasks.md Phase 2 · design: hashflow logo (blue), pulsing Live dot, "Rigs: 5/6", "+$14.237", "3 sugestãoões de troca", BTC/ETC/RVN prices, kWh button, language switch (new, not in design)
